...
content_length: 51101
---

# Agents

**Source:** [https://huyenchip.com/2025/01/07/agents.html](https://huyenchip.com/2025/01/07/agents.html)
...
_This post is adapted from the
* Agents
* section of [
* AI Engineering
* ](<https://amzn.to/49j1cGS>) (2025) with minor edits to make it a standalone post._
**Notes** :
...
Given an environment, the success of an agent in an environment depends on
* the tool it has access to
* and
* the strength of its AI planner
...
>
* Tips
* for making an agent better at planning.
>

...
async def vector_search(
    ...
    """Recherche sémantique dans la base vectorielle de la session.
    ...
    # `list[str]`-only Pydantic schema generated by @function_tool. Accept
    # both shapes here and normalize to list[str] before dispatching.

...
- Spike #235: `document-research`, a standard Agent Skill that runs the 8-step documentary research process
  ...
  runner and N-run parallel battery; open evaluation on a third-party topic; decision note. (PR pending, relates to #235, #234)
...
- DeepSeek-V4-Flash-0731 official local results on the fixed `vllm-node-b12x` recipe (2026-09-03, DSpark speculative
  ...
  multiplier range) and campaign report §29. ([#233](https://github.com/BittnerPierre/agentic-research/pull/233), closes #232)

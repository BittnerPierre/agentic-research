...
| 3. Sélection et extraction | `03-extraits/extraits.jsonl`, `03-extraits/corpus-retenu.md` | Sélection des sources réellement pertinentes ; extraction des passages, citations, données, faits, en conservant provenance et localisation. | Chaque question secondaire a au moins un extrait ou une mention explicite « aucun extrait trouvé ». Chaque extrait est verbatim et localisé. |

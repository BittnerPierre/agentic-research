...
- Add Chroma MCP backend (late attachment + chunking on add) with configurable MCP tool names.
...
- `src/dataprep/embeddings.py`: embedding factory for Chroma.

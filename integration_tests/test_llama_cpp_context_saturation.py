...
class TestLlamaCppContextSaturation:
    ...
    @pytest.mark.dgx
    def test_ctx_saturation_before_fix_instruct(self, instruct_endpoint: str, tokenizer):
    ...
    @pytest.mark.integration
    @pytest.mark.dgx
    def test_ctx_saturation_after_fix_instruct(self, instruct_endpoint: str, tokenizer):
        ...
        assert (
            total_tokens <= self.TARGET_CTX_SIZE + 100
    ...
    @pytest.mark.integration
    @pytest.mark.dgx
    def test_json_generation_stability_instruct(self, instruct_endpoint: str, tokenizer):
...
Make the content detailed and substantial."""
    ...
    @pytest.mark.dgx
    @pytest.mark.slow
    def test_ctx_saturation_reasoning_model(self, reasoning_endpoint: str, tokenizer):
        ...
        if output_tokens >= 1500:
            ...
            print(
                f"⚠ Output tronqué à {output_tokens} tokens (attendu: troncature <{expected_max_output})"
            )
